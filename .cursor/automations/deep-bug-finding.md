...
- Inspect recent commits and diffs in this repo.
- Open a PR with a minimal fix when confidence is high.
- Post findings or a "no critical bugs found" summary to Slack when configured.
- Update MEMORIES.md to track open and rejected bugs across runs.
